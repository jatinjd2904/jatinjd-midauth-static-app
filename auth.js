...
function logout() {
  ...
  try {
    if (window.Microsoft &&
      ...
      console.log('[Auth] ✅ Chat session closed');
    } else {
  ...
  // IMPORTANT: Add delay to ensure chat close and event handlers complete before redirect
  setTimeout(() => {
  ...
  }, 500); // 500ms delay to allow chat close and event handlers to complete
}
